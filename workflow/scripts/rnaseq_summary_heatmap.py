#!/usr/bin/env python3
"""
Summary heatmap for RNA-seq DESeq2 results (results/transcriptomics/deseq2/).

Same visual layout as summary_heatmap.py (used for metabolomics/proteomics
limma), adapted for DESeq2 output conventions:
  - significance column is "FDR" (not "adj.P.Val")
  - continuous variables are named "{variable}_results.csv" (not "contrast_*.csv")
"""
import argparse
import math
...
fig.suptitle(f"Transcriptomics  —  FDR < {FDR}",
